...
def main() -> None:
    ...
    parser.add_argument("--inters", type=str, help="interventions filename")
    parser.add_argument("--sorties", type=str, help="sorties filename")
    parser.add_argument("--pdd", type=str, help="pdd filename")
